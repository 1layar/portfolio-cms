...
export class UserResolverBase {
  ...
  async starredProjects(
    @graphql.Parent() parent: User,
    @graphql.Args() args: ProjectFindManyArgs
  ): Promise<Project[]> {
    const results = await this.service.findStarredProjects(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => Config, { nullable: true })
  @nestAccessControl.UseRoles({
    resource: "Config",
    action: "read",
    possession: "any",
  })
  async config(@graphql.Parent() parent: User): Promise<Config | null> {
    const result = await this.service.getConfig(parent.id);
