...
export class ProjectResolverBase {
  ...
  async category(@graphql.Parent() parent: Project): Promise<Category | null> {
  ...
  async stars(@graphql.Parent() parent: Project): Promise<User | null> {
    const result = await this.service.getStars(parent.id);
